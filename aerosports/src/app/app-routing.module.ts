...
export const routes: Routes = [
  ...
  // home
  { path: ':location/home', loadChildren: () => import('./components/pages/home/home.module').then(m => m.HomeModule), data: { breadcrumb: 'Homepage' } },
  ...
  // About
  { path: ':location/about', canActivateChild: [LocationGurderGuard], loadChildren: () => import('./components/pages/about/about.module').then(m => m.AboutModule), data: { breadcrumb: 'About Us' } },
  // Contact
